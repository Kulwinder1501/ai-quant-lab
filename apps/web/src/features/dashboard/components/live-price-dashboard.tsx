          ...
          <GlassPanel className="mb-8 p-4 border-cyan-500/30 bg-gradient-to-r from-slate-950 via-slate-900 to-cyan-950/30 shadow-xl">
            <div className="flex flex-wrap items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                <span
                  className={`inline-flex items-center gap-2 rounded-full px-3.5 py-1.5 text-xs font-extrabold tracking-wide border shadow-sm ${isStreaming
                  ...
                  <div className="inline-flex rounded-xl border border-white/10 bg-slate-900/80 p-1">
                    {(["1d", "1h", "15m"] as const).map((tf) => (
                      <button
                        ...
                        className={`rounded-lg px-3 py-1.5 text-xs font-bold uppercase transition ${timeframe === tf
