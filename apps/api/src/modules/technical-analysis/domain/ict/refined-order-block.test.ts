...
describe("computeRefinedOrderBlock", () => {
  ...
  it("reports the HTF distance alone when no LTF order block is nested inside it", () => {
    ...
    const htfOb = makeOb({ id: "htf-1", type: "BULLISH", top: 24200, bottom: 24000 });
  ...
  it("finds a nested LTF order block strictly inside the HTF range and reports compression", () => {
    ...
    const htfOb = makeOb({ id: "htf-1", type: "BULLISH", top: 24200, bottom: 24000 }); // 200-pt range
  ...
  it("picks the HTF order block nearest to current price when several are active", () => {
    const near = makeOb({ id: "htf-near", type: "BULLISH", top: 24120, bottom: 24080 }); // mean 24100
    const far = makeOb({ id: "htf-far", type: "BEARISH", top: 25200, bottom: 25100 }); // mean 25150
