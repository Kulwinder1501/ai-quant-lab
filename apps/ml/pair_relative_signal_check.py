...
def main() -> int:
    ...
    with psycopg.connect(database_url, autocommit=True) as connection:
        ...
        audit = run_leakage_audit(
            ...
            # Not persistence-dominated: label_from_future_close is a transient direction target,
            # exactly the case FEATURE_LAG is meant to catch real leakage on.
            # persistence_dominated=True is reserved for a target like volatility where the
            # signal genuinely persists bar-to-bar.
        )
